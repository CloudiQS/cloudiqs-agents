...
- Search for recent news: funding, acquisitions, technology projects, cloud announcements (use web_search "COMPANY NAME news 2025")
- Note: company_description = one sentence describing what they do

**People intelligence (find 2-3 contacts, not just one):**
Primary: CTO, IT Director, Head of Infrastructure, VP Engineering, CFO (funding angle)
Secondary: CEO (if <100 employees), Head of DevOps, Head of Cloud, Procurement Manager
...
**Talk track:**
Write one paragraph (3-4 sentences) of exactly what to say in the opening 30 seconds of a cold call. Make it specific to this company's project, funding eligibility signal, and the cost reduction they may not know about. Start with something they will recognise immediately. No generic script.
...
curl -X POST http://localhost:8787/lead \
  ...
  -d '{
    ...
    "deal_name": "GB-FND-[COMPANY]-MAP-Q[Q][YY]-$[ARR]k",
