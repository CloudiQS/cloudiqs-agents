...
- Search for recent news: funding rounds, investors, AWS announcements (use web_search "COMPANY NAME news 2025")
- Note: company_description = one sentence describing what they do

**People intelligence (find 2-3 contacts, not just one):**
Primary: CTO, Head of Engineering, VP Engineering
Secondary: CEO (startups often have no dedicated IT — CEO may own infrastructure decisions), Head of DevOps, Engineering Manager
...
**Talk track:**
Write one paragraph (3-4 sentences) of exactly what to say in the opening 30 seconds of a cold call. Make it specific to this startup's funding stage, product category, and AWS cost or architecture challenge. Start with something they will recognise immediately. No generic script.
