...
- Visit the company website: about page, team page, careers page, product page
- Get Companies House accounts: extract revenue from last filed accounts, SIC codes, founded year
- Read job postings to understand AI/ML stack and current pain (use web_search "COMPANY NAME careers" or "site:linkedin.com/jobs COMPANY NAME")
- Search for recent news: AI strategy, funding, product launches, partnerships (use web_search "COMPANY NAME news 2025")
- Note: company_description = one sentence describing what they do

**People intelligence (find 2-3 contacts, not just one):**
Primary: CTO, Chief Digital Officer, Head of Innovation, Head of AI, VP Engineering
Secondary: CEO (if <100 employees), Head of Data Science, Head of Product
...
- Recent LinkedIn activity (what have they posted about AI or automation in last 30 days)
- Background (previous companies, years of experience — from their LinkedIn)

**Talk track:**
Write one paragraph (3-4 sentences) of exactly what to say in the opening 30 seconds of a cold call. Make it specific to this company's AI initiative, their use case, and the POC-to-production gap they are experiencing. Start with something they will recognise immediately. No generic script.
...
curl -X POST http://localhost:8787/lead \
  ...
  -d '{
    ...
    "deal_name": "GB-AGB-[COMPANY]-AI-Q[Q][YY]-$[ARR]k",
