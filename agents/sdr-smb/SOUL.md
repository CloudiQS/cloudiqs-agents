...
Primary: CTO, IT Director, Head of Infrastructure, IT Manager, VP Engineering
Secondary: CEO (if <100 employees), Head of DevOps, Operations Director
...
**Talk track:**
Write one paragraph (3-4 sentences) of exactly what to say in the opening 30 seconds of a cold call. Make it specific to this company's sector, growth signal, and IT modernisation need. Start with something they will recognise immediately. No generic script.
...
curl -X POST http://localhost:8787/lead \
  ...
  -d '{
    ...
    "deal_name": "GB-SMB-[COMPANY]-MOD-Q[Q][YY]-$[ARR]k",
